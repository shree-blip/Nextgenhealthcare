          ...
          <div className="p-10 sm:p-14 lg:p-16 flex flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-5">
              ...
              <Link
                ...
                style={{ color: COLORS.navy }}
              >
                {t('pages:aeoSchema.closing.ctaSecondary')}
              </Link>
            </div>
          </div>
